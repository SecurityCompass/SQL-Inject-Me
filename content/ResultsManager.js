...
ResultsManager.prototype = {
    ...
    showResults: function(testManager, errorstr){
        ...
        results += "<h2>SQL Injection String Test Results</h2>";
        if (sortedResults.length) {
            ...
            results += "<h3>No SQL Injection vulnerabilities found.</h3>"
        }
        results +="<div class='footer'>";
        var now = new Date();
        results += 'Results genenerated on ' + getMonthName(now.getMonth())  + " " + now.getDate() + ", " + now.getFullYear();
        results += ' for ' + this.testPageURL;
        results += "</div>"
        results+="</body></html>";
